...
CREATE TABLE test_z_order (x String, y String) ENGINE = MergeTree() ORDER BY (x, y) SETTINGS order_by_mode = 'zcurve';
...
CREATE TABLE test_z_order (x UInt64, y UInt64) ENGINE = MergeTree() ORDER BY (x, y) SETTINGS order_by_mode = 'zcurve';
INSERT INTO test_z_order VALUES (0, 0), (0, 1), (0, 2), (0, 3), (1, 0), (1, 1), (1, 2), (1, 3), (2, 0), (2, 1), (2, 2), (2, 3), (3, 0), (3, 1), (3, 2), (3, 3);
OPTIMIZE TABLE test_z_order FINAL;
SELECT * FROM test_z_order;
SELECT * FROM test_z_order ORDER BY x ASC;
...
ENGINE = MergeTree
ORDER BY (x, y)
SETTINGS order_by_mode = 'zcurve', index_granularity = 2;
INSERT INTO test_z_order VALUES ('0','0'), ('0','1'), ('0','2'), ('0','3'), ('1','0'), ('1','1'), ('1','2'), ('1','3'), ('2','0'), ('2','1'), ('2','2'), ('2','3'), ('3','0'), ('3','1'), ('3','2'), ('3','3');
OPTIMIZE TABLE test_z_order FINAL;
