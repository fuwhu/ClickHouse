...
public:
    explicit FunctionMortonDecode(ContextPtr context) : selector(context)
    {
        ...
        selector.registerImplementation<TargetArch::AVX2, TargetSpecific::AVX2::FunctionMortonDecode>();
#endif
    }
...
void registerFunctionMortonDecode(FunctionFactory & factory)
{
    ...
    factory.registerAlias("zCurveDecode", FunctionMortonDecode::name);
}
}
