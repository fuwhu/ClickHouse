...
{
    size_t operator()(const IUniqueKeyIndex & index) const
    {
...
class UniqueKeyIndexCache
    : public LRUCache<UUIDAndPartName, IUniqueKeyIndex, UUIDAndPartNameHash, UniqueKeyIndexWeightFunction>
{
    using Base = LRUCache<UUIDAndPartName, IUniqueKeyIndex, UUIDAndPartNameHash, UniqueKeyIndexWeightFunction>;
public:
    using Base::Base;
