...
struct IcebergFile
{
    ...
    std::shared_ptr<ReadBufferFromFileBase> read_buf;
    ...
    virtual void initializeSplits() { throw Exception(ErrorCodes::NOT_IMPLEMENTED, "initializeSplits is not implemented for the file of format {}.", getFormatName()); }

    virtual bool splitsInitialized() { throw Exception(ErrorCodes::NOT_IMPLEMENTED, "splitsInitialized is not implemented for the file of format {}.", getFormatName()); }

    virtual void loadSplitsStatistics() { throw Exception(ErrorCodes::NOT_IMPLEMENTED, "loadSplitsStatistics is not implemented for the file of format {}.", getFormatName()); }

    virtual bool splitsStatisticsLoaded() { throw Exception(ErrorCodes::NOT_IMPLEMENTED, "splitsStatisticsLoaded is not implemented for the file of format {}.", getFormatName()); }

    virtual bool filteredWithSplitsStatistics() { throw Exception(ErrorCodes::NOT_IMPLEMENTED, "filteredWithSplitsStatistics is not implemented for the file of format {}.", getFormatName()); }

    virtual String getFormatName() const = 0;

    static IcebergFilePtr newFile(const String & format);

    virtual void getFileSortingKeyRanges(std::vector<SortColumnDescription> & /*order_key_description*/, int /*direction*/) { throw Exception(ErrorCodes::NOT_IMPLEMENTED, "getFileSortingKeyRanges is not implemented for the file of format {}.", getFormatName()); }
...
class IcebergFileSource final : public ISource, WithContext
{
public:
...
private:
    ...
    static std::unique_ptr<RecycleThreadPoolThread<ThreadFromGlobalPoolNoTracingContextPropagation>> static_recycle_thread;
