 ...
 */
class ColumnMapV2 final : public COWHelper<IColumnHelper<ColumnMapV2>, ColumnMapV2>
{
private:
    friend class COWHelper<IColumnHelper<ColumnMapV2>, ColumnMapV2>;
...
public:
    /** Create immutable column using immutable arguments. This arguments may be shared with other columns.
      ...
      */
    using Base = COWHelper<IColumnHelper<ColumnMapV2>, ColumnMapV2>;
    ...
    const ColumnPtr & getColumnPtr(int index) const { return columns[index].column; }
