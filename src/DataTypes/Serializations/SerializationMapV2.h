...
class SerializationMapV2 final : public SimpleTextSerialization
{
private:
...
public:
    SerializationMapV2(const SerializationPtr & key_type_, const SerializationPtr & value_type_, const SerializationPtr & nested_);
    ...
    void enumerateStreams(SubstreamPath & path, const StreamCallback & callback, const SubstreamData & data) const override;
