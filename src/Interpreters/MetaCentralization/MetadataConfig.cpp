...
MetadataCentralizationConfig MetadataCentralizationConfig::fromConfig(const Poco::Util::AbstractConfiguration & config)
{
    ...
    cfg.generate_local_manifest_from_local_metadata = config.getBool("metadata_centralization.generate_local_manifest_from_local_metadata", false);
    cfg.initialize_centralized_metadata = config.getBool("metadata_centralization.initialize_centralized_metadata", false);
