...
struct ITokenExtractor
{
    ...
    virtual bool nextInStringLike(const char * data, size_t length, size_t * pos, String & out, bool set_percent_separator) const = 0;
    ...
    virtual void stringLikeToBloomFilter(const char * data, size_t length, BloomFilter & bloom_filter, bool set_percent_separator) const = 0;
...
class ITokenExtractorHelper : public ITokenExtractor
{
    ...
    void stringLikeToGinFilter(const char * data, size_t length, GinFilter & gin_filter) const override
    {
        ...
        while (cur < length && static_cast<const Derived *>(this)->nextInStringLike(data, length, &cur, token, false))
...
struct NgramTokenExtractor final : public ITokenExtractorHelper<NgramTokenExtractor>
{
    ...
    bool nextInStringLike(const char * data, size_t length, size_t * pos, String & token, bool set_percent_separator) const override;
