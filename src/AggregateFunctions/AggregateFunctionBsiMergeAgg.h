...
{
public:
    explicit AggregateFunctionBsiMergeAgg(const DataTypes & argument_types_)
        : IAggregateFunctionDataHelper<AggregateFunctionBsiAggData, AggregateFunctionBsiMergeAgg>(argument_types_, {}, createResultType())
    {
    }
    ...
    void add(AggregateDataPtr __restrict place, const IColumn ** columns, size_t row_num, Arena *) const override
    {
        ...
        data(place).add(col_agg.getData(), offset, size, true);
    }

    void merge(AggregateDataPtr __restrict place, ConstAggregateDataPtr rhs, Arena *) const override { data(place).merge(data(rhs), true); }
