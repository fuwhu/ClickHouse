...
struct PoolWithFailoverBase<TNestedPool>::PoolState
{
    ...
    static bool compare(const PoolState & lhs, const PoolState & rhs, bool use_slowdown_count)
    {
        if (use_slowdown_count)
            return std::forward_as_tuple(lhs.error_count, lhs.remote_error_count, lhs.slowdown_count, lhs.config_priority, lhs.priority, lhs.random)
                < std::forward_as_tuple(rhs.error_count, rhs.remote_error_count, rhs.slowdown_count, rhs.config_priority, rhs.priority, rhs.random);
        return std::forward_as_tuple(lhs.error_count, lhs.remote_error_count, lhs.config_priority, lhs.priority, lhs.random)
            < std::forward_as_tuple(rhs.error_count, rhs.remote_error_count, rhs.config_priority, rhs.priority, rhs.random);
    }
